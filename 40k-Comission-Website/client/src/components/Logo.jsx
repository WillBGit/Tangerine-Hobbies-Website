...
export default function Logo({ size = 120 }) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Crossbar */}
      <rect x="172" y="163" width="156" height="33" fill="#ff00ff"/>
      {/* Transition bar just below crossbar */}
      <rect x="190" y="196" width="120" height="8" fill="#ff00ff"/>
      {/* Stem 1 */}
      ...
      {/* Bottom arc: PAINT! PAINT! PAINT! — 20 chars, 148°→32° (through 90° = bottom) */}
      <ArcText
        text="PAINT! PAINT! PAINT!"
        cx={cx} cy={cy} r={215}
